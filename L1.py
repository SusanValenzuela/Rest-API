...
# ========================================================
#  SQL Data Operations
#  Handles CRUD operations for Users and Games
...
def create_user():
    ...
    cursor = conn.cursor()
    try:
        # AI GENERATED: Parametrized insert for security
        cursor.execute(
...
# rebuild hateoes cause db cant see them>?
...
def get_user(user_id):
    conn = get_db_connection()
    cursor = conn.cursor(dictionary=True)
    #AI GENERATED: Fetching specific user record
...
def update_user(user_id):
    ...
    conn = get_db_connection()
    cursor = conn.cursor()
    # AI GENERATED: Dynamic field mapping for partial updates (PATCH)
    cursor.execute(
...
# check owner exists
# cross check with user sql code 
# no more ai (yay!) hopefully 
